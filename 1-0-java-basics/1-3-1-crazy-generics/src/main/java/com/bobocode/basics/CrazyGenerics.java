...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
        ...
        public <T extends BaseEntity> Optional<T> findMax(Iterable<T> elements,
         ...
         */
        public <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) {
